    ...
    className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-4">
            ...
            <div className="space-y-4 max-w-[300px]">
                ...
                <p className="text-dark2">TCJ is a Platform dedicated to empowering aspiring developers. From beginner tutorials to advanced programming concepts, we provide a comprehensive learning experience designed to help you master coading skills,build project,and launch your tech career.</p>
            </div>
            {/* second section*/}
                ...
                <div className="space-y-4">
                    ...
                    <div className="text-dark2">
                        <ul className="space-y-2 text-lg">
                            ...
                            <li className="cursor-pointer hover:text-secondary duration-200">E-Learning development</li>
                        </ul>
                    </div>
